...
avx_3(const float *input_array, float *result_array, int size,
      int *array_index)
{
  if (size == 1)
  {
...
__attribute__((always_inline)) static inline void
avx_7(const float *input_array, float *result_array, int size,
      int *array_index)
{
  if (size == 7)
  {
...
__attribute__((always_inline)) static inline void
avx_15(const float *input_array, float *result_array, int size,
       int *array_index)
{
  if (size == 15)
  {
  ...
  {
    avx_7(input_array, result_array, size,
          array_index);
  }
}

/* kernel with vectorization up to AVX */
void vlogf_avx_option1(const float *input_array, float *result_array,
                       unsigned int size)
{
  int index = 0;
...
/* kernel with vectorization up to AVX */
void vlogf_avx_option2(const float *input_array, float *result_array,
                       unsigned int size)
{
  int index = 0;
  int *array_index = &index;
...
/* kernel with vectorization up to AVX */
void vlogf_avx_option3(const float *input_array, float *result_array,
                       unsigned int size)
{
  int index = 0;
  int *array_index = &index;
