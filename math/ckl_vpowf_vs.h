#ifndef CKL_VPOWF_VS_H
#define CKL_VPOWF_VS_H
...
#include "ckl_common.h"
    typedef void (*ckl_vpowf_vs_func_t)(const float *, const float, float *, unsigned int);
    ...
    void ckl_vpowf_vs(const float *input_array, const float input_value, float *result_array,
...
#include "ckl_ifunc.h"
    RESOLVE_FUNC(ckl_vpowf_vs_func_t, vpowf_vs, ckl_vpowf_vs)
...
#define OP2 
    ...
    vpowf_vs_avx512_7(const float *input_array,
    ...
    static inline void __CKL_FN_ATTR_AVX512
    vpowf_vs_avx512_15(const float *input_array, const float input_value, float *result_array, int size,
                    int *array_index)
    {
        if (size == 1)
        {
    ...
    static inline void __CKL_FN_ATTR_AVX512 vpowf_vs_avx512_16_group(const float *input_array,
                                                                  const float input_value,
                                                                  float *result_array,
                                                                  unsigned int size)
    {
        ...
        if (size > 16)
        {
            ...
            if (rest)
                vpowf_vs_avx512_15(input_array, input_value, result_array, rest, array_index);
        }
        else if (size == 16)
        {
            AVX512_f2d_8__2_ops(OP1, OP2, NAME_AVX512_POWF2D)
        ...
        {
            vpowf_vs_avx512_15(input_array, input_value, result_array, size, array_index);
        }
    }

    /* kernel with vectorization up to AVX512 */
    static inline void __CKL_FN_ATTR_AVX512 vpowf_vs_avx512(const float *input_array,
                                                         const float input_value,
                                                         float *result_array,
                                                         unsigned int size)
    {
    ...
    vpowf_vs_avx2_3(const float *input_array, const float input_value,
               ...
               unsigned int size)
    {
        ...
        if (size > 4)
        {
            ...
            if (rest)
                vpowf_vs_avx2_3(input_array, input_value, result_array, rest, array_index);
        }
        else if (size == 4)
        {
            AVX_f2d_4__1_ops(OP1, OP2, NAME_AVX2_POWF2D)
    ...
    vpowf_vs_avx_3(const float *input_array,
                const float input_value,
                float *result_array,
                int size,
                int *array_index)
              ...
              unsigned int size)
    {
        ...
        if (size > 4)
        {
            ...
            if (rest)
                vpowf_vs_avx_3(input_array, input_value, result_array, rest, array_index);
        }
        else if (size == 4)
        {
            SSE_f2d_2__2_ops(OP1, OP2, NAME_SSE_POWF2D)
    ...
    vpowf_vs_sse_3(const float *input_array,
                const float input_value,
                float *result_array,
                int size,
                int *array_index)
              ...
              unsigned int size)
    {
        ...
        if (size > 4)
        {
            ...
            if (rest)
                vpowf_vs_sse_3(input_array, input_value, result_array, rest, array_index);
        }
        else if (size == 4)
        {
            SSE_f2d_2__2_ops(OP1, OP2, NAME_SSE_POWF2D)
