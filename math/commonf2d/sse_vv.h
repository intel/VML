...
#define SSE_vv_f2d_2__1(name) SSE_vv_f2d_2(0, name)
/*Call 2 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__2(name) SSE_vv_f2d_2__1(name) \
    SSE_vv_f2d_2(1, name)
/*Call 3 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__3(name) SSE_vv_f2d_2__2(name) \
    SSE_vv_f2d_2(2, name)
/*Call 4 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__4(name) SSE_vv_f2d_2__3(name) \
    SSE_vv_f2d_2(3, name)
/*Call 5 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__5(name) SSE_vv_f2d_2__4(name) \
    SSE_vv_f2d_2(4, name)
/*Call 6 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__6(name) SSE_vv_f2d_2__5(name) \
    SSE_vv_f2d_2(5, name)
/*Call 7 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__7(name) SSE_vv_f2d_2__6(name) \
    SSE_vv_f2d_2(6, name)
/*Call 8 SSE function for 2 doubles*/
#define SSE_vv_f2d_2__8(name) SSE_vv_f2d_2__7(name) \
    SSE_vv_f2d_2(7, name)
...
#define SCALAR_vv_f2d_1(i, name) SCALAR_vv_f2d_1_TMP(i, name)
#define SCALAR_vv_f2d_1_TMP(i, name)                                           \
    if(ckl_pre_hook)                                                           \
        ckl_pre_hook(ckl_pre_hook_args);                                       \
