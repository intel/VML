...
#define AVX_f2d_4__0(name)
/*Call 1 AVX function for 4 doubles*/
#define AVX_f2d_4__1(name) AVX_f2d_4(0, name)
/*Call 2 AVX function for 4 doubles*/
#define AVX_f2d_4__2(name) \
  AVX_f2d_4__1(name)       \
      AVX_f2d_4(1, name)
/*Call 3 AVX function for 4 doubles*/
#define AVX_f2d_4__3(name) \
  AVX_f2d_4__2(name)       \
      AVX_f2d_4(2, name)
/*Call 4 AVX function for 4 doubles*/
#define AVX_f2d_4__4(name) \
  AVX_f2d_4__3(name)       \
      AVX_f2d_4(3, name)
...
#define AVX_f2d_4_mask4_TMP(i, name)                                    \
  if ((size - 4 * i) == 1)                                              \
  {                                                                     \
    AVX_f2d_4__##i(name) _mm_maskstore_ps(                              \
...
#define AVX_f2d_2__0(name)
/*Call 1 SSE function for 2 doubles*/
#define AVX_f2d_2__1(name) AVX_f2d_2(0, name)
/*Call 2 SSE function for 2 doubles*/
#define AVX_f2d_2__2(name) \
  AVX_f2d_2__1(name)       \
      AVX_f2d_2(1, name)
/*Call 3 SSE function for 2 doubles*/
#define AVX_f2d_2__3(name) \
  AVX_f2d_2__2(name)       \
      AVX_f2d_2(2, name)
/*Call 4 SSE function for 2 doubles*/
#define AVX_f2d_2__4(name) \
  AVX_f2d_2__3(name)       \
      AVX_f2d_2(3, name)
