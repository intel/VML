#ifndef CKL_VPOW_SV_HOOK_H
#define CKL_VPOW_SV_HOOK_H
...
#include "ckl_common.h"
    typedef void (*ckl_vpow_sv_hook_func_t)(const double, const double *, double *, unsigned int, 
    ...
    void ckl_vpow_sv_hook(const double input_value, const double *input_array, double *result_array,
                  unsigned int size, ckl_hook_func_t pre_hook, void * pre_args, 
                  ckl_hook_func_t post_hook, void * post_args) __attribute__((ifunc("vpow_sv_hook_ifunc")));
#else
void ckl_vpow_sv_hook(const double input_value, const double *input_array, double *result_array,
              unsigned int size, ckl_hook_func_t pre_hook, void * pre_args, 
...
#include "ckl_ifunc.h"
    RESOLVE_FUNC(ckl_vpow_sv_hook_func_t, vpow_sv_hook, ckl_vpow_sv_hook)
...
#define SCALAR_1(i, name) SCALAR_1_TMP(i, name)
    ...
    static inline void __CKL_FN_ATTR_AVX512 vpow_sv_hook_avx512(const double input_value,
                                                        const double *input_array,
                                                        double *result_array,
                                                        unsigned int size, 
                                                        ckl_hook_func_t pre_hook, 
