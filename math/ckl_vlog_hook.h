#ifndef CKL_VLOG_HOOK_H
#define CKL_VLOG_HOOK_H
...
#include "ckl_common.h"
    typedef void (*ckl_vlog_hook_func_t)(const double *, double *, unsigned int, ckl_hook_func_t pre_hook, 
    ...
    void ckl_vlog_hook(const double *input_array, double *result_array,
                  unsigned int size, ckl_hook_func_t pre_hook, 
                                   void * pre_args, ckl_hook_func_t post_hook, void * post_args) __attribute__((ifunc("vlog_hook_ifunc")));
#else
void ckl_vlog_hook(const double *input_array, double *result_array,
              unsigned int size, ckl_hook_func_t pre_hook, 
                                   void * pre_args, ckl_hook_func_t post_hook, void * post_args);
...
#include "ckl_ifunc.h"
    RESOLVE_FUNC(ckl_vlog_hook_func_t, vlog_hook, ckl_vlog_hook)
...
#define OP2 POST_HOOK_OP(post_hook, post_args)
    ...
    static inline void __CKL_FN_ATTR_AVX512 vlog_hook_avx512_16_group(const double *input_array, double *result_array,
                                                                 unsigned int size, ckl_hook_func_t pre_hook, 
				   void * pre_args, ckl_hook_func_t post_hook, void * post_args)
    {
        int index = 0;
    ...
    static inline void __CKL_FN_ATTR_AVX512 vlog_hook_avx512(const double *input_array, double *result_array,
                                                        unsigned int size, ckl_hook_func_t pre_hook, 
				   void * pre_args, ckl_hook_func_t post_hook, void * post_args)
    {
        int index = 0;
